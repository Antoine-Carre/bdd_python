...
if TerrG=='06' or TerrG=='13'or TerrG=='33' or TerrG=='36'or TerrG=='44' or TerrG=='59' or TerrG=='63' or TerrG=='67' or TerrG=='75' or TerrG=='77' or TerrG=='78' or TerrG=='91' or TerrG=='92' or TerrG=='93' or TerrG=='94' or TerrG=='95':
    st.write('Sélectionnez votre secteur :')
...
if TerrG=='07'or TerrG=='15'or TerrG=='16'or TerrG=='21'or TerrG=='34'or TerrG=='35' or TerrG=='76':
    #st.write('Sélectionnez votre secteur :')
    #cumul = ['07', '07 cumulé']
    #cumul = st.selectbox('', cumul)
    ...
    #if cumul==f'{TerrG':
    #  compteProCum.columns = compteProCum.columns.astype(str)
    #  figComptePro = px.bar(compteProCum, x='datePresentation', y=f'{TerrG}')
      
    #if cumul=='07 cumulé':
    #    figComptePro = px.bar(compteProCum, x='datePresentation', y=f'{TerrG} cumulé')

    fig4 = px.line(df4[df4['territoire']==f'Département {TerrG}'], x='Unnamed: 0', y=['Utilisateurs','Sessions','Pages vues']) 

if TerrG != '07' and TerrG != '15' and TerrG != '16' and TerrG != '21' and TerrG != '34' and TerrG != '35' and TerrG != '76':
    #Compte Pro
...
if TerrG != '07' and TerrG != '15' and TerrG != '34' and TerrG != '35' and TerrG != '76' and TerrG != '21':
    ...
    col2.markdown(html_string_2, unsafe_allow_html=True)TerrG=='16'or TerrG=='21'or TerrG=='34'or TerrG=='35' or TerrG=='76':
    #st.write('Sélectionnez votre secteur :')
    #cumul = ['07', '07 cumulé']
    #cumul = st.selectbox('', cumul)
